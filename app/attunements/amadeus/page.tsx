...
const AmadeusPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      <div className="flex h-screen w-full">
        {/* Left panel: Title and bullets */}
        <div className="w-1/2 bg-white flex flex-col justify-center items-start p-8">
          <h2 className="text-3xl font-semibold text-black mb-4">Amadeus</h2>
          <p className="text-gray-700 text-base mb-4">
            The Amadeus attunement.
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>Connects to the shamanic energy used by the Guarani tribe from Amazon</li>
            <li>It brings tools for astral projection</li>
            <li>It brings tools for planetary healing</li>
          </ul>
        </div>
