...
const ReikiPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      <div className="flex h-screen w-full">
        {/* Left panel: Title and bullets */}
        <div className="w-1/2 bg-white flex flex-col justify-center items-start p-8">
          <h2 className="text-3xl font-semibold text-black mb-4">Reiki</h2>
          <p className="text-gray-700 text-base mb-4">
            The Reiki attunement.
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>Connects to the bright light of the Univers</li>
            <li>Brings tools to activate the physical, emotional, mental and spiritual bodies</li>
            <li>Offers the capacity to heal by laying hands</li>
            <li>Gives the capacity to send light in space and time</li>
          </ul>
        </div>
