...
const KarunaPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      <div className="flex h-screen w-full">
        {/* Left panel: Title and bullets */}
        <div className="w-1/2 bg-white flex flex-col justify-center items-start p-8">
          <h2 className="text-3xl font-semibold text-black mb-4">Karuna</h2>
          <p className="text-gray-700 text-base mb-4">
            The Karuna attunement.
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>Connects to the golden light field of compassion and life of the Universe</li>
            <li>Brings symbols that connect to different entities of light</li>
            <li>Brings tools for opening radiating portals of light</li>
            <li>Imprints the healing vibration of life upon the cellular and energetic structures of the body</li>
          </ul>
        </div>
