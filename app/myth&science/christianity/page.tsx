...
const jesusRows: JesusRow[] = [
  ...
  { event: "Temptation by Satan", psychology: "Shadow confrontation.", biology: "Amygdala tests + prefrontal cortex override." },
  ...
  { event: "Death on the Cross", psychology: "Total surrender.", biology: "Central nervous system shutdown." },
